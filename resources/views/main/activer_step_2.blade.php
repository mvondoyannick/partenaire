        ...
        <div class="row">
          <form action="{{route('activerGo')}}" method="post">
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="header">
                  <h4 class="title">Finaliser l'activation du compte client {{$data->phone}}</h4>
                </div>
                <div class="content">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="tel" name="phone" disabled class="form-control" placeholder="Numéro téléphone" required value="{{$data->phone}}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>CNI</label>
                        <input type="text" name="cni" class="form-control" placeholder="Carte nationale d'identité" required value="{{$data->cni}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Nom</label>
                        <input type="text" name="name"  class="form-control" placeholder="Numéro téléphone" required value="{{$data->name}}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Prénom</label>
                        <input type="text" name="second_name" class="form-control" placeholder="Carte nationale d'identité" required value="{{$data->second_name}}">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Sexe</label>
                        <input type="text" name="sexe"  class="form-control" placeholder="Sexe" required value="{{$data->sexe}}">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
