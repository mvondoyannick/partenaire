...
@section('content')
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <form action="{{route('creditGo')}}" method="post">
          {{csrf_field()}}
          <div class="col-md-6">
            <div class="card">
              <div class="header">
                <h4 class="title">Crediter un compte client</h4>
              </div>
              <div class="content">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="amount" class="form-control" placeholder="Montant à recharger">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Montant à recharger</label>
                      <input type="number" name="amount_confirm" class="form-control" placeholder="Montant à recharger confirmer">
                    </div>
                  </div>
